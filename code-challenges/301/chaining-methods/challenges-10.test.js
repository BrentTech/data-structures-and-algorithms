...
const totalSum = (input) => {
  // reduce concat arrays
  // reduce using acc = acc + val;
};
...
const divisibleByFiveTwoToThePower = (input) => {
  // conditional logic to remove non numbers likely using filter() like previous challenge;
  // math.pow with map to make the squared array
};
...
let findShortest = (data) => {
  // filter over arrays to find the shortest character
  //reduce that array to just the name
}
